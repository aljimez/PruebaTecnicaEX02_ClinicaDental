...
CREATE TABLE IF NOT EXISTS visitas(
	...
	odontologos_codigo INT NOT NULL,
	...
	FOREIGN KEY (odontologos_codigo) REFERENCES odontologos(codigo) ON UPDATE CASCADE ON DELETE CASCADE
);
...
INSERT INTO visitas(clientes_id, odontologos_codigo, proceso, time, prices) VALUES (2, 3, 'Implantacion de coronas', '2022-04-25 09:05:00', 300);
INSERT INTO visitas(clientes_id, odontologos_codigo, proceso, time, prices) VALUES (1, 2, 'Empastes', '2022-04-25 10:00:00', 202);
INSERT INTO visitas(clientes_id, odontologos_codigo, proceso, time, prices) VALUES (3, 1, 'Blanqueamiento dental', '2022-04-25 12:30:00', 390);
